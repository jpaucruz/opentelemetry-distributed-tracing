...
public class CreateOrderService implements CreateOrderUseCase {
    ...
    public CreateOrderService(CreateOrderPort createOrderPort, CreateOrderMapper mapper){
    ...
    public CreateOrderResult createOrder(CreateOrderCommand command) {
        ...
        Order order = createOrderPort.createOrder(Order.create(command.productId(), command.quantity()));
